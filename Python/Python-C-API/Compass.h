...
static PyObject *compass_calculate_heading(PyObject *self, PyObject *args) {
  ...
  const char *error = PARSE_TUPLE(args, "iO!O!", &convention, &PyArray_Type, &accelerometer_array,
  ...
  return Py_BuildValue(
      "f", FusionCompassCalculateHeading(convention, accelerometer_vector, magnetometer_vector));
}
