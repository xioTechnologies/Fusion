...
static PyObject *hard_iron_solve(HardIron *self, PyObject *args) {
    PyObject *samples_object;

    if (PyArg_ParseTuple(args, "O", &samples_object) == 0) {
        return NULL;
    }
    ...
    if (np_array_nx3_to(&samples_array, &numberOfSamples, samples_object) != 0) {
        return NULL;
    }
...
static PyMethodDef hard_iron_methods[] = {
    ...
    {"solve", (PyCFunction) hard_iron_solve, METH_VARARGS | METH_STATIC, ""},
    {NULL} /* sentinel */
};
