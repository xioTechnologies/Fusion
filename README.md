...
| `recoveryTriggerPeriod` | Acceleration and magnetic recovery trigger period (in seconds). A value of zero will disable the acceleration and magnetic rejection features. A period of 5 seconds is appropriate for most applications.                                                  |
